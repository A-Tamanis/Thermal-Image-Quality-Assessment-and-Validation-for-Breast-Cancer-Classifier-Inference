...
def evaluate_breast_quality_on_mask(
    ...
    cold_k_sigma=0.9,           # cold pixels = mu - k*sigma
    max_cold_frac=0.30,         # max allowed cold-blob fraction of breast band area
    min_var_intensity=150.0,    # minimal variance of intensities
...
def check_background_quality(
    ...
    threshold=15.0           # Laplacian variance threshold
):
    """
    Returns:
...
def run_check(image_path: str) -> Dict[str, Any]:
    """
    Pipeline wrapper for 90 degree background check
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="90 metrics / breast-band quality check")
