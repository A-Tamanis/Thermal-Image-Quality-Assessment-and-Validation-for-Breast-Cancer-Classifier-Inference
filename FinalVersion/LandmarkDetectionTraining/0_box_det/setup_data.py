...
IMAGES_RAW  = PROJECT_ROOT / "images_pose_0"   # folder with all images
LABELS_RAW  = PROJECT_ROOT / "labels_pose_0"   # folder with all txt labels

DATASET_ROOT = PROJECT_ROOT / "0box_dataset"
